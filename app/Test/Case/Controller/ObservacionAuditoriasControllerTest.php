<?php
App::uses('ObservacionAuditoriasController', 'Controller');

/**
 * ObservacionAuditoriasController Test Case
 */
class ObservacionAuditoriasControllerTest extends ControllerTestCase {
