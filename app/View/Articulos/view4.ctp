        ...
        <div class="container">
            <div class="items">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6" id="row-<?php echo $bodegaped['Bodegaped']['id']; ?>">
                        <div class="item shadow mb-4">
                            <h3 class="item-title"><strong>DESCRIPCION:</strong><?php echo $this->Html->link($bodegaped['Bodegaped']['DESCRIPCION'], array('action' => 'view2', $bodegaped['Bodegaped']['id'])); ?></h3>
